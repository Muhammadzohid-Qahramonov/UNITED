...
import '../users/user_type.dart' as _i2;
...
abstract class User implements _i1.TableRow<int?>, _i1.ProtocolSerialization {
  ...
  factory User.fromJson(Map<String, dynamic> jsonSerialization) {
    return User(
      ...
      type: _i2.UserType.fromJson((jsonSerialization['type'] as String)),
      workingBranch: jsonSerialization['workingBranch'] as String?,
      notifications: jsonSerialization['notifications'] as bool,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'type': type.toJson(),
      if (workingBranch != null) 'workingBranch': workingBranch,
...
class _UserImpl extends User {
  ...
  User copyWith({
    ...
    _i2.UserType? type,
    Object? workingBranch = _Undefined,
    bool? notifications,
  }) {
    return User(
      ...
      type: type ?? this.type,
      workingBranch: workingBranch is String?
          ? workingBranch
          : this.workingBranch,
...
class UserUpdateTable extends _i1.UpdateTable<UserTable> {
  ...
  _i1.ColumnValue<_i2.UserType, _i2.UserType> type(_i2.UserType value) =>
      _i1.ColumnValue(
        table.type,
        value,
      );

  _i1.ColumnValue<String, String> workingBranch(String? value) =>
      _i1.ColumnValue(
        table.workingBranch,
        value,
      );

  _i1.ColumnValue<bool, bool> notifications(bool value) => _i1.ColumnValue(
    table.notifications,
    value,
  );
}
...
class UserTable extends _i1.Table<int?> {
  UserTable({super.tableRelation}) : super(tableName: 'users') {
    ...
    workingBranch = _i1.ColumnString(
      'workingBranch',
      this,
    );
    notifications = _i1.ColumnBool(
      'notifications',
      this,
    );
  }
  ...
  late final _i1.ColumnEnum<_i2.UserType> type;

  late final _i1.ColumnString workingBranch;

  late final _i1.ColumnBool notifications;
